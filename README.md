...
game/           Game-specific code
  ...
  door.lua        Door entity — visual-only, no interact()/state; grid-aligned world object marking where new boxes fly in from
